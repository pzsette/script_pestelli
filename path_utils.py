...
def get_file_folder():
    return utils.read_config_value('PATH', 'file_folder')


def get_to_send_folder_path():
    return os.path.join(get_file_folder(), utils.read_config_value('PATH', 'to_send_folder'))


def get_sent_folder_path():
    return os.path.join(get_file_folder(), utils.read_config_value('PATH', 'sent_folder'))


def get_data_path():
    return os.path.join(get_file_folder(), utils.read_config_value('PATH', 'data_folder'))
